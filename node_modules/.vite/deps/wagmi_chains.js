import { $ as isEqual, Ca as InvalidAddressError, Cr as formatTransactionRequest$1, Da as keccak256, Er as extract, Fa as numberToHex$1, G as toNumber, H as size, I as fromBytes, J as validate, K as toString, L as fromNumber, La as toHex, Lr as TipAboveFeeCapError$1, M as assert$1, Ma as toBytes$1, Mn as maxUint256, Mt as assertRequest, N as concat$1, P as from$4, Q as fromString$1, R as fromString, Sr as defineTransactionRequest, To as BaseError, U as slice, Ua as trim, V as random, Va as hexToNumber$1, W as toBigInt, Y as concat, Ya as pad, Z as fromHex, ct as stringify, d as InvalidChainIdError$1, i as getCallError, ia as encodeFunctionData, ka as hexToBytes, kr as FeeCapTooHighError$1, lt as BaseError$1, oa as parseAccount, q as trimLeft, va as concatHex, vn as maxUint16, ya as isAddress, za as hexToBigInt } from "./call-DJwxWRjU.js";
import { $ as sha384, A as toHex$2, At as sendTransaction, Bt as readContract, C as toRpcList$1, D as fromHex$1, E as from$5, Et as formatTransactionReceipt$1, F as createCurve, G as validate$2, H as checksum, I as mapToCurveSimpleSWU, J as toHex$1, K as from$6, L as Field, M as toTuple$2, N as yParityToV, Nt as AccountNotFoundError, O as fromRpc$5, P as createHasher, Q as sha256$1, R as fromHex$2, S as fromRpcList$1, T as extract$1, Tt as defineTransactionReceipt, U as fromPublicKey, Ut as formatLog, V as assert$3, Vt as parseEventLogs, W as isEqual$1, X as sha256$2, Y as keccak256$1, Yt as getTransactionType, Z as validate$1, _t as extendSchema, b as recoverPublicKey, bn as toRlp, bt as serializeAccessList, cn as defineBlock, d as getSelector, dn as formatTransaction$1, en as sha256, et as sha512, gt as defineChain, j as toRpc$5, k as fromTuple$2, kt as writeContract, o as verifyHash, q as fromHex$3, un as defineTransaction, vt as serializeTransaction$3, w as assert$2, wn as getAction, wt as getCode, x as verify$4, y as recoverAddress, yt as toYParitySignatureArray, z as toHex$3 } from "./writeContractSync-B6_Zs6X7.js";
...
function fromTuple(tuple) {
	...
	const args = {
		address: keyId,
		expiry: typeof expiry !== "undefined" ? hexToNumber(expiry) || void 0 : void 0,
		type: keyType,
		chainId: chainId === "0x" ? 0n : toBigInt(chainId),
		...typeof expiry !== "undefined" ? { expiry: hexToNumber(expiry) || void 0 } : {},
		...typeof limits !== "undefined" && Array.isArray(limits) && limits.length > 0 ? { limits: limits.map((limitTuple) => {
			const [token, limit, period] = limitTuple;
			return {
				token,
				limit: hexToBigint(limit),
				...typeof period !== "undefined" ? { period: hexToNumber(period) } : {}
			};
		}) } : {},
		...typeof scopes !== "undefined" && Array.isArray(scopes) ? { scopes: scopes.flatMap((scopeTuple) => {
...
function hash$1(authorization) {
	...
	return keccak256$1(fromHex$2(authorizationTuple));
}
/**
...
function toTuple(authorization) {
	...
	return [[
		...
		type,
		address,
		expiry !== null && expiry !== void 0 && expiry !== 0 || limitsValue || callsValue ? numberToHex(expiry ?? 0) : void 0,
		limitsValue || callsValue ? limitsValue ?? [] : void 0,
		callsValue
	].filter((x) => typeof x !== "undefined"), ...signature ? [signature] : []];
}
...
function getSignPayload(envelope, options = {}) {
	...
	if (options.from) return keccak256$1(concat$1("0x04", sigHash, resolve(options.from)));
	return sigHash;
}
/**
...
function hash(envelope, options = {}) {
	return keccak256$1(serialize$1({
		...envelope,
		...options.presign ? {
			signature: void 0,
...
async function signKeyAuthorization(account, parameters) {
	...
	return from$1({
		...
		limits,
		scopes,
		signature: from$3(await account.sign({ hash: getSignPayload$1({
			address: accessKeyAddress,
			chainId,
			expiry,
			limits,
	...
	async verifyHash(client, parameters) {
		...
		if (envelope) {
			if (envelope?.type === "keychain" && mode === "allowAccessKey") {
				const accessKeyAddress = fromPublicKey(from$6(envelope.inner.publicKey));
				...
				const innerPayload = envelope.version === "v2" ? keccak256(concat$1("0x04", hash, address)) : hash;
