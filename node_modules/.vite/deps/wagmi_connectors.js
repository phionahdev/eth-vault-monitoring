...
import { Fa as numberToHex, ai as SwitchChainError, pi as UserRejectedRequestError, ri as ResourceUnavailableRpcError, xa as getAddress } from "./call-DJwxWRjU.js";
import { Ot as withRetry } from "./writeContractSync-B6_Zs6X7.js";
import { ct as withTimeout } from "./_esm-DrtHKWX0.js";
import { i as ProviderNotFoundError, n as injected, o as ChainNotConfiguredError, r as createConnector, t as mock } from "./mock-B3tirVvE.js";
...
function _setup(parameters) {
	return createConnector((config) => {
		...
		async function getAccountsModule() {
			return await import("./core-6tojvfff.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)).catch(() => {
		...
		return {
			...
			async getClient({ chainId } = {}) {
				const provider = await getProvider();
				return Object.assign(provider.getClient({ chainId }), { account: provider.getAccount() });
			},
			async getProvider() {
		...
		async getProvider() {
			if (!walletProvider) {
				...
				const { createBaseAccountSDK } = await (() => {
					try {
						return import("./connectors-BAmGQkBM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
		...
		async getProvider() {
			if (!walletProvider) {
				const { createCoinbaseWalletSDK } = await (() => {
					try {
						return import("./connectors-BAf1IrvW.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
			...
			if (!metamask) {
				if (!metamaskPromise) {
					const { createEVMClient } = await (async () => {
						try {
							return import("./connectors-VsKZX-t2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
						} catch {
				...
				try {
					if (!accounts?.length && !isReconnecting) {
						const { RpcSchema } = await (() => {
							try {
								return import("./connectors-DhAv-_zE.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
							} catch {
						...
						const { z } = await (() => {
							try {
								return import("./connectors-kNAGj1Z2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
							} catch {
		...
		async getProvider() {
			...
			if (!provider_) {
				const { default: SDK } = await (() => {
					try {
						return import("./connectors-D9vTPqx2.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
				...
				provider_ = new (await ((async () => {
					const Provider = await (() => {
						try {
							return import("./connectors-Bwg9gDdn.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
						} catch {
		...
		async getProvider({ chainId } = {}) {
			async function initProvider() {
				...
				const { EthereumProvider } = await (() => {
					try {
						return import("./connectors-BlguciL1.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
					} catch {
