import { A as IntegerOutOfRangeError, Ai as InvalidSerializedTransactionError, At as decodeFunctionResult, B as padRight, Ba as hexToBool, C as erc6492SignatureValidatorAbi, Ca as InvalidAddressError$1, Ci as ContractFunctionZeroDataError, Cr as formatTransactionRequest, Ct as isBytes$1, Da as keccak256$1, Do as size, Dr as getNodeError, Dt as numberToHexUnpadded, Er as extract$1, Et as numberToBytesLE, F as fromBoolean, Fa as numberToHex, Fi as TransactionReceiptNotFoundError, G as toNumber$1, Gr as InternalRpcError, H as size$1, Hi as formatEther, I as fromBytes$2, Ia as stringToHex, Ii as TransactionReceiptRevertedError, J as validate$4, Kr as InvalidInputRpcError, L as fromNumber, La as toHex$3, Li as WaitForTransactionReceiptTimeoutError, Lr as TipAboveFeeCapError, Ma as toBytes$2, Mi as InvalidStorageKeySizeError, Mn as maxUint256$1, Mo as parseAbiParameter, Mt as assertRequest, N as concat$1, Ni as TransactionExecutionError, No as parseSignature, Oi as InvalidLegacyVError, Oo as isHex, Ot as utf8ToBytes$1, P as from$8, Pa as bytesToHex, Pi as TransactionNotFoundError, Po as splitParameters, Q as fromString, Qo as formatAbiParameters, R as fromString$1, Ri as prettyPrint, Sa as LruMap$1, Si as ContractFunctionRevertedError, St as inRange, T as multicall3Abi, Ti as RawContractError, To as BaseError, Tr as defineFormatter, Tt as numberToBytesBE, U as slice$1, Ua as trim, Va as hexToNumber, Vi as formatGwei, Vo as InvalidAbiParametersError, X as from$7, Xo as modifiers, Yi as decodeAbiParameters, Yo as isStructSignature, Z as fromHex$3, Za as padHex, Zo as formatAbiItem$1, _o as BytesSizeMismatchError$1, _t as bytesToNumberLE, at as toString, ba as checksumAddress, bi as CallExecutionError, bt as ensureBytes, c as ChainMismatchError, ct as stringify$1, d as InvalidChainIdError, da as bytesRegex$1, dt as abool, et as size$2, fa as integerRegex$1, fo as AbiEventSignatureEmptyTopicsError, ft as abytes$1, ga as concat, gi as RpcRequestError, gt as bytesToNumberBE, h as multicall3Bytecode, ha as sliceHex, ht as bytesToHex$1, ia as encodeFunctionData, io as AbiDecodingZeroDataError, it as toNumber, j as InvalidLengthError, ji as InvalidSerializedTransactionTypeError, jo as parseStructs, jt as isAddressEqual, ka as hexToBytes, ki as InvalidSerializableTransactionError, ko as formatAbiItem, kr as FeeCapTooHighError, kt as validateObject, l as ChainNotFoundError, la as encodeAbiParameters, lt as BaseError$1, m as erc6492SignatureValidatorByteCode, mt as bitMask, na as PositionOutOfBoundsError$1, nt as toBigInt, o as encodeDeployData, oa as parseAccount, ot as trimLeft, pa as slice, po as AbiEventSignatureNotFoundError, pt as bitLen, q as trimLeft$1, qa as InvalidHexValueError, qi as stringify, qo as InvalidAbiItemError, r as withResolvers, ro as AbiDecodingDataSizeTooSmallError, rt as toBoolean, st as validate$5, t as call, ta as createCursor, tt as slice$2, ut as aInRange, va as concatHex, vo as DecodeLogDataMismatch, vt as concatBytes$1, wa as toEventSelector, wt as memoized, xa as getAddress, xi as ContractFunctionExecutionError, xr as serializeStateOverride, xt as hexToBytes$1, y as erc1271Abi, ya as isAddress, yo as DecodeLogTopicsMismatch, yt as createHmacDrbg, z as padLeft, za as hexToBigInt, zr as UnknownNodeError } from "./call-DJwxWRjU.js";
import { r as sha256$5, t as secp256k1$1 } from "./secp256k1-CABImEb_.js";
...
async function recoverPublicKey$1({ hash, signature }) {
	...
	const { secp256k1 } = await import("./secp256k1-CABImEb_.js").then((n) => n.n);
	return `0x${(() => {
...
function includesArgs(parameters) {
	...
	function isEqual(input, value, arg) {
		try {
			...
			if (input.type === "string" || input.type === "bytes") return keccak256$1(toBytes$2(value)) === arg;
			return value === arg;
		} catch {
			return false;
		}
...
function sha256(value, options = {}) {
	const { as = typeof value === "string" ? "Hex" : "Bytes" } = options;
	const bytes = sha256$1(from$7(value));
	if (as === "Bytes") return bytes;
	return fromBytes$2(bytes);
}
/**
...
var InvalidSerializedSizeError$1 = class extends BaseError$1 {
	constructor({ publicKey }) {
		super(`Value \`${publicKey}\` is an invalid public key size.`, { metaMessages: ["Expected: 33 bytes (compressed + prefix), 64 bytes (uncompressed) or 65 bytes (uncompressed + prefix).", `Received ${size$1(from$8(publicKey))} bytes.`] });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
function decodeAddress(cursor, options = {}) {
	...
	return [wrap(fromBytes$2(slice$2(value, -20))), 32];
}
/** @internal */
...
function encodeString(value) {
	...
	return {
		dynamic: true,
		encoded: concat$1(padRight(fromNumber(size$1(hexValue), { size: 32 })), ...parts)
	};
}
/** @internal */
function encodeTuple(value, options) {
	...
	return {
		dynamic,
		encoded: dynamic ? encode$1(preparedParameters) : concat$1(...preparedParameters.map(({ encoded }) => encoded))
	};
}
/** @internal */
...
function toHex(signature) {
	...
	const r = signature.r;
	const s = signature.s;
	return concat$1(fromNumber(r, { size: 32 }), fromNumber(s, { size: 32 }), typeof signature.yParity === "number" ? fromNumber(yParityToV(signature.yParity), { size: 1 }) : "0x");
}
/**
...
var InvalidSerializedSizeError = class extends BaseError$1 {
	constructor({ signature }) {
		super(`Value \`${signature}\` is an invalid signature size.`, { metaMessages: ["Expected: 64 bytes or 65 bytes.", `Received ${size$1(from$8(signature))} bytes.`] });
		Object.defineProperty(this, "name", {
			enumerable: true,
			configurable: true,
			writable: true,
...
function recoverPublicKey(options) {
	...
	const { r, s, yParity } = signature;
	return from$6(new secp256k1.Signature(BigInt(r), BigInt(s)).addRecoveryBit(yParity).recoverPublicKey(from$8(payload).substring(2)));
}
/**
...
function verify(options) {
	...
	return secp256k1.verify(signature, from$7(payload), toBytes(publicKey), ...hash ? [{
		prehash: true,
		lowS: true
	}] : []);
}
...
function wrap$1(value) {
	...
	return concat$1(signature, suffix, fromNumber(size$1(suffix), { size: 32 }), magicBytes$1);
}
/**
...
function fromAbi(abi, name, options) {
	...
	const abiItems = abi.filter((abiItem) => {
		if (isSelector) {
			if (abiItem.type === "function" || abiItem.type === "error") return getSelector(abiItem) === slice$1(name, 0, 4);
...
function wrap(value) {
	...
	return concat$1(encode(from$4("address, bytes, bytes"), [
		to,
		data,
		signature
	]), magicBytes);
...
//#endregion
export { sha384 as $, commitmentToVersionedHash as $t, toHex as A, sendTransaction as At, encode as B, readContract as Bt, toRpcList as C, getContractError as Cn, assertTransactionLegacy as Ct, fromHex as D, receiptStatuses as Dt, from$2 as E, parseAbiItem as En, formatTransactionReceipt as Et, createCurve as F, getBlockNumber as Ft, validate$2 as G, prepareTransactionRequest as Gt, checksum as H, decodeEventLog as Ht, mapToCurveSimpleSWU as I, withCache as It, toHex$2 as J, getTransactionError as Jt, from$6 as K, fillTransaction as Kt, Field as L, poll as Lt, toTuple$1 as M, assertCurrentChain as Mt, yParityToV as N, AccountNotFoundError as Nt, fromRpc$1 as O, withRetry as Ot, createHasher as P, AccountTypeNotSupportedError as Pt, sha256$2 as Q, commitmentsToVersionedHashes as Qt, fromHex$1 as R, wait as Rt, fromRpcList as S, recoverPublicKey$1 as Sn, assertTransactionEIP2930 as St, extract as T, parseAbiParameters as Tn, defineTransactionReceipt as Tt, fromPublicKey as U, formatLog as Ut, assert$3 as V, parseEventLogs as Vt, isEqual as W, estimateGas as Wt, sha256 as X, toBlobSidecars as Xt, keccak256 as Y, getTransactionType as Yt, validate$3 as Z, toBlobs as Zt, validate$1 as _, EstimateGasExecutionError as _n, extendSchema as _t, watchBlockNumber as a, estimateMaxPriorityFeePerGas as an, getTypesForEIP712Domain as at, recoverPublicKey as b, toRlp as bn, serializeAccessList as bt, NotFoundError as c, defineBlock as cn, InvalidDomainError as ct, getSelector as d, formatTransaction as dn, hashMessage as dt, sha256$3 as en, sha512 as et, getTransactionReceipt as f, transactionType as fn, toPrefixedMessage as ft, unwrap as g, MaxFeePerGasTooLowError as gn, defineChain as gt, getSerializedTransactionType as h, Eip1559FeesNotSupportedError as hn, fromRlp as ht, waitForTransactionReceipt as i, estimateFeesPerGas as in, domainSeparator as it, toRpc$1 as j, sendRawTransaction as jt, fromTuple as k, writeContract as kt, from as l, formatBlock as ln, InvalidPrimaryTypeError as lt, parseTransaction as m, BaseFeeScalarError as mn, isHash as mt, sendTransactionSync as n, blobsToCommitments as nn, hashStruct as nt, verifyHash as o, getGasPrice as on, serializeTypedData as ot, getTransaction as p, BlockNotFoundError as pn, presignMessagePrefix as pt, fromHex$2 as q, getChainId as qt, sendRawTransactionSync as r, getTransactionCount as rn, hashTypedData as rt, serializeSignature as s, getBlock as sn, validateTypedData as st, writeContractSync as t, blobsToProofs as tn, hashDomain as tt, fromAbi as u, defineTransaction as un, InvalidStructTypeError as ut, wrap$1 as v, bytesToRlp as vn, serializeTransaction as vt, assert$2 as w, getAction as wn, getCode as wt, verify as x, recoverAddress$1 as xn, assertTransactionEIP1559 as xt, recoverAddress as y, hexToRlp as yn, toYParitySignatureArray as yt, toHex$1 as z, observe as zt };

//# sourceMappingURL=writeContractSync-B6_Zs6X7.js.map