import { S as split, _ as u32, a as anumber, b as rotlSH, d as createXOFer, g as toBytes$1, h as swap32IfBE, l as createHasher, n as abytes$1, o as aoutput, r as aexists, s as clean, t as Hash, v as rotlBH, x as rotlSL, y as rotlBL } from "./utils-DnNcD3un.js";
...
function fromHex$1(hex, toOrOpts) {
	...
	const to = opts.to;
	if (to === "number") return hexToNumber$1(hex, opts);
...
for (let round = 0, R = _1n$1, x = 1, y = 0; round < 24; round++) {
	...
	for (let j = 0; j < 7; j++) {
		...
		if (R & _2n) t ^= _1n$1 << (_1n$1 << /* @__PURE__ */ BigInt(j)) - _1n$1;
	}
	_SHA3_IOTA.push(t);
}
...
var docsPath$2 = "/docs/contract/encodeFunctionData";
...
function fromBytes$1(bytes, toOrOpts) {
	...
	return bytesToHex$1(bytes, opts);
}
/**
...
async function call(client, args) {
	...
	try {
		...
		const { offchainLookup, offchainLookupSignature } = await import("./ccip-CkJI4MAS.js").then((n) => n.n);
...
//#endregion
export { isEqual as $, SliceOffsetOutOfBoundsError$2 as $a, bytesToString as $i, minInt176 as $n, ParseRpcError as $r, maxInt248 as $t, IntegerOutOfRangeError as A, numberToBytes as Aa, InvalidSerializedTransactionError as Ai, maxUint240 as An, parseAbi as Ao, FeeCapTooLowError as Ar, decodeFunctionResult as At, padRight as B, hexToBool as Ba, StateAssignmentConflictError as Bi, maxUint80 as Bn, InvalidAbiParameterError as Bo, AtomicReadyWalletRejectedUpgradeError as Br, maxInt16 as Bt, erc6492SignatureValidatorAbi as C, InvalidAddressError as Ca, ContractFunctionZeroDataError as Ci, maxUint192 as Cn, InvalidDefinitionTypeError as Co, formatTransactionRequest as Cr, isBytes as Ct, universalResolverResolveAbi as D, keccak256 as Da, FeeConflictError as Di, maxUint224 as Dn, size$2 as Do, getNodeError as Dr, numberToHexUnpadded as Dt, textResolverAbi as E, toSignature as Ea, getUrl as Ei, maxUint216 as En, setErrorConfig as Eo, extract as Er, numberToBytesLE as Et, fromBoolean as F, numberToHex as Fa, TransactionReceiptNotFoundError as Fi, maxUint48 as Fn, InvalidParenthesisError as Fo, NonceTooHighError as Fr, maxInt120 as Ft, toNumber as G, InvalidBytesBooleanError$1 as Ga, gweiUnits as Gi, minInt120 as Gn, InvalidParameterError as Go, InternalRpcError as Gr, maxInt192 as Gt, size as H, hexToString as Ha, formatEther as Hi, maxUint96 as Hn, InvalidAbiTypeParameterError as Ho, BundleTooLargeError as Hr, maxInt168 as Ht, fromBytes as I, stringToHex as Ia, TransactionReceiptRevertedError as Ii, maxUint56 as In, CircularReferenceError as Io, NonceTooLowError as Ir, maxInt128 as It, validate as J, SizeOverflowError$2 as Ja, decodeErrorResult as Ji, minInt144 as Jn, UnknownTypeError as Jo, InvalidRequestRpcError as Jr, maxInt216 as Jt, toString as K, InvalidHexBooleanError$1 as Ka, weiUnits as Ki, minInt128 as Kn, SolidityProtectedKeywordError as Ko, InvalidInputRpcError as Kr, maxInt200 as Kt, fromNumber as L, toHex as La, WaitForTransactionReceiptTimeoutError as Li, maxUint64 as Ln, InvalidSignatureError as Lo, TipAboveFeeCapError as Lr, maxInt136 as Lt, assert as M, toBytes as Ma, InvalidStorageKeySizeError as Mi, maxUint256 as Mn, parseAbiParameter as Mo, IntrinsicGasTooHighError as Mr, assertRequest as Mt, concat as N, boolToHex as Na, TransactionExecutionError as Ni, maxUint32 as Nn, parseSignature as No, IntrinsicGasTooLowError as Nr, maxInt104 as Nt, universalResolverReverseAbi as O, boolToBytes as Oa, InvalidLegacyVError as Oi, maxUint232 as On, isHex as Oo, ExecutionRevertedError as Or, utf8ToBytes as Ot, from as P, bytesToHex$1 as Pa, TransactionNotFoundError as Pi, maxUint40 as Pn, splitParameters as Po, NonceMaxValueError as Pr, maxInt112 as Pt, fromString$1 as Q, SizeExceedsPaddingSizeError$2 as Qa, bytesToNumber as Qi, minInt168 as Qn, formatAbiParameters as Qo, MethodNotSupportedRpcError as Qr, maxInt240 as Qt, fromString as R, fromHex$1 as Ra, prettyPrint as Ri, maxUint72 as Rn, InvalidStructSignatureError as Ro, TransactionTypeNotSupportedError as Rr, maxInt144 as Rt, erc4626Abi as S, LruMap as Sa, ContractFunctionRevertedError as Si, maxUint184 as Sn, InvalidArrayError as So, defineTransactionRequest as Sr, inRange as St, multicall3Abi as T, toSignatureHash as Ta, RawContractError as Ti, maxUint208 as Tn, BaseError$1 as To, defineFormatter as Tr, numberToBytesBE as Tt, slice as U, trim$2 as Ua, formatUnits as Ui, minInt104 as Un, InvalidFunctionModifierError as Uo, ChainDisconnectedError as Ur, maxInt176 as Ut, random as V, hexToNumber$1 as Va, formatGwei as Vi, maxUint88 as Vn, InvalidAbiParametersError as Vo, AtomicityNotSupportedError as Vr, maxInt160 as Vt, toBigInt as W, IntegerOutOfRangeError$1 as Wa, etherUnits as Wi, minInt112 as Wn, InvalidModifierError as Wo, DuplicateIdError as Wr, maxInt184 as Wt, from$1 as X, padBytes as Xa, bytesToBigInt as Xi, minInt16 as Xn, modifiers as Xo, LimitExceededRpcError as Xr, maxInt232 as Xt, concat$1 as Y, pad$2 as Ya, decodeAbiParameters as Yi, minInt152 as Yn, isStructSignature as Yo, JsonRpcVersionUnsupportedError as Yr, maxInt224 as Yt, fromHex as Z, padHex as Za, bytesToBool as Zi, minInt160 as Zn, formatAbiItem$1 as Zo, MethodNotFoundRpcError as Zr, maxInt24 as Zt, batchGatewayAbi as _, concatBytes$1 as _a, SocketClosedError as _i, maxUint152 as _n, BytesSizeMismatchError as _o, minInt8 as _r, bytesToNumberLE as _t, getChainContractAddress as a, prepareEncodeFunctionData as aa, SwitchChainError as ai, maxInt64 as an, AbiEncodingArrayLengthMismatchError as ao, minInt224 as ar, toString$1 as at, erc20Abi as b, checksumAddress as ba, CallExecutionError as bi, maxUint168 as bn, InvalidAbiDecodingTypeError as bo, minInt96 as br, ensureBytes as bt, ChainMismatchError as c, toFunctionSelector as ca, UnknownBundleIdError as ci, maxInt80 as cn, AbiErrorInputsNotFoundError as co, minInt240 as cr, stringify as ct, InvalidChainIdError as d, bytesRegex as da, UnsupportedNonOptionalCapabilityError as di, maxUint104 as dn, AbiEventNotFoundError as do, minInt32 as dr, abool as dt, fromBytes$1 as ea, ProviderDisconnectedError as ei, maxInt256 as en, AbiConstructorNotFoundError as eo, minInt184 as er, size$1 as et, deploylessCallViaBytecodeBytecode as f, integerRegex as fa, UnsupportedProviderMethodError as fi, maxUint112 as fn, AbiEventSignatureEmptyTopicsError as fo, minInt40 as fr, abytes as ft, addressResolverAbi as g, concat$2 as ga, RpcRequestError as gi, maxUint144 as gn, AbiFunctionSignatureNotFoundError as go, minInt72 as gr, bytesToNumberBE as gt, multicall3Bytecode as h, sliceHex as ha, HttpRequestError as hi, maxUint136 as hn, AbiFunctionOutputsNotFoundError as ho, minInt64 as hr, bytesToHex as ht, getCallError as i, encodeFunctionData as ia, RpcError as ii, maxInt56 as in, AbiDecodingZeroDataError as io, minInt216 as ir, toNumber$1 as it, InvalidLengthError as j, stringToBytes as ja, InvalidSerializedTransactionTypeError as ji, maxUint248 as jn, parseStructs as jo, InsufficientFundsError as jr, isAddressEqual as jt, toRpc as k, hexToBytes$1 as ka, InvalidSerializableTransactionError as ki, maxUint24 as kn, formatAbiItem as ko, FeeCapTooHighError as kr, validateObject as kt, ChainNotFoundError as l, encodeAbiParameters as la, UnknownRpcError as li, maxInt88 as ln, AbiErrorNotFoundError as lo, minInt248 as lr, BaseError as lt, erc6492SignatureValidatorByteCode as m, sliceBytes as ma, WalletConnectSessionSettlementError as mi, maxUint128 as mn, AbiFunctionNotFoundError as mo, minInt56 as mr, bitMask as mt, createBatchScheduler as n, PositionOutOfBoundsError as na, ResourceNotFoundRpcError as ni, maxInt40 as nn, AbiDecodingDataSizeInvalidError as no, minInt200 as nr, toBigInt$1 as nt, encodeDeployData as o, parseAccount as oa, TransactionRejectedRpcError as oi, maxInt72 as on, AbiEncodingBytesSizeMismatchError as oo, minInt232 as or, trimLeft$1 as ot, deploylessCallViaFactoryBytecode as p, slice$2 as pa, UserRejectedRequestError as pi, maxUint120 as pn, AbiEventSignatureNotFoundError as po, minInt48 as pr, bitLen as pt, trimLeft as q, InvalidHexValueError$1 as qa, stringify$1 as qi, minInt136 as qn, InvalidAbiItemError as qo, InvalidParamsRpcError as qr, maxInt208 as qt, withResolvers as r, solidityError as ra, ResourceUnavailableRpcError as ri, maxInt48 as rn, AbiDecodingDataSizeTooSmallError as ro, minInt208 as rr, toBoolean as rt, ChainDoesNotSupportContract as s, getAbiItem as sa, UnauthorizedProviderError as si, maxInt8 as sn, AbiEncodingLengthMismatchError as so, minInt24 as sr, validate$1 as st, call as t, createCursor as ta, ProviderRpcError as ti, maxInt32 as tn, AbiConstructorParamsNotFoundError as to, minInt192 as tr, slice$1 as tt, ClientChainNotConfiguredError as u, arrayRegex as ua, UnsupportedChainIdError as ui, maxInt96 as un, AbiErrorSignatureNotFoundError as uo, minInt256 as ur, aInRange as ut, erc1155Abi as v, concatHex as va, TimeoutError as vi, maxUint16 as vn, DecodeLogDataMismatch as vo, minInt80 as vr, concatBytes as vt, erc721Abi as w, toEventSelector as wa, CounterfactualDeploymentFailedError as wi, maxUint200 as wn, UnsupportedPackedAbiType as wo, rpcTransactionType as wr, memoized as wt, erc20Abi_bytes32 as x, getAddress as xa, ContractFunctionExecutionError as xi, maxUint176 as xn, InvalidAbiEncodingTypeError as xo, serializeStateOverride as xr, hexToBytes as xt, erc1271Abi as y, isAddress as ya, WebSocketRequestError as yi, maxUint160 as yn, DecodeLogTopicsMismatch as yo, minInt88 as yr, createHmacDrbg as yt, padLeft as z, hexToBigInt as za, AccountStateConflictError as zi, maxUint8 as zn, UnknownSignatureError as zo, UnknownNodeError as zr, maxInt152 as zt };

//# sourceMappingURL=call-DJwxWRjU.js.map